...
async function shouldBehaveLikeUnderlyingPaycerPoolStrategy(strategyIndex) {
  let pool, strategy
  let collateralToken
  let user1, user2

  describe(`Underlying Paycer pool strategy specific tests[${strategyIndex}]`, function () {
    ...
    describe('whitelisted withdraw', function () {
      ...
      it('Should not pay withdraw fee to underlying Paycer pool', async function () {
...
module.exports = {shouldBehaveLikeUnderlyingPaycerPoolStrategy}
