...
async function shouldBehaveLikeEarnMakerStrategy(strategyIndex) {
  ...
  describe(`MakerStrategy specific tests for strategy[${strategyIndex}]`, function () {
    beforeEach(async function () {
      ...
      const initData = paycerEarnDripImpl.interface.encodeFunctionData('initialize', [pool.address, Address.DAI])
      ...
      earnDrip = await ethers.getContractAt('PaycerEarnDrip', proxy.address)
