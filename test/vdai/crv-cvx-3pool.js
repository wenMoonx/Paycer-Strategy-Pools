...
describe('vDAI Pool with Convex Crv3PoolStrategy', function () {
  ...
  beforeEach(async function () {
    ...
    await setupVPool(this, {
      ...
      strategies: [
        {name: 'ConvexStrategyDAI', type: StrategyType.CURVE, config: strategyConfig, feeCollector: feeAcct.address},
      ],
    })
