...
task('deploy-pool', 'Deploy paycer pool')
  .addParam('pool', 'Paycer pool name')
  .addOptionalParam('release', 'Paycer release semantic version. It will create release file under /releases directory')
  .addOptionalParam(
    'deployParams',
