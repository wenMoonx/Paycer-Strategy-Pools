...
const deployFunction = async function ({getNamedAccounts, deployments}) {
  ...
  const poolVersion = await read(VDAI.contractName, {}, 'VERSION')
  const poolAccountantVersion = await read(PoolAccountant, {}, 'VERSION')
  deployFunction.id = `${VDAI.poolParams[1]}-v${poolVersion}_${poolAccountantVersion}`
  return true
}
module.exports = deployFunction
module.exports.tags = ['VDAI']
